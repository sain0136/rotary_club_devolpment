          ...
          <div class="details-list">
            <ul>
              ...
              <li>
                ...
                >
                {{
                  clubData.charter_date
                }}/
                {{
                  clubData.mother_club
                }}
              </li>
            </ul>
          </div>
...
.services .inner-box .block-number {
  position: relative;
  font-weight: 700;
  font-size: 60px;
  line-height: 1em;
