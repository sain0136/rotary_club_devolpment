...
export default {
  ...
  async created() {
    watchEffect(() => {
      ...
      this.address = `Meeting Location: ${clubData.club_address} ${clubData.club_city} , ${clubData.club_province} `
      ...
      try {
        ...
        if (
          ...
          this.$refs.flink_footer_club.style.display =
            'none'
        } else {
          this.$refs.flink_footer_club.style.display =
            'inline-block'
        ...
        if (
          ...
          this.$refs.tlink_footer_club.style.display =
            'none'
        } else {
