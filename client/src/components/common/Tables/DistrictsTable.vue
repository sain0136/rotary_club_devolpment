<template>
  <!-- Districts table -->
  <div class="district_table-container">
        ...
        <td>
          <button
            ...
            @click="
              () =>
                this.$router.push(
                  `/district/${district.district_id}/home`,
                )
            "
          >
            <font-awesome-icon
...
export default {
  ...
  methods: {
    async deleteDistrict(
      ...
      if (
        confirm(
          `Are you sure you want to delete ${districtName} with an ID of ${districtId} ?`,
        )
      ) {
